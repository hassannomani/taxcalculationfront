...
export class ReturnSubmissionService {
  ...
  private url : string ='http://localhost:8080/api/v1/calculation/save';
  private url1 : string ='http://localhost:8080/api/v1/calculation/save';
  private url2 : string ='http://localhost:8080/api/v1/calculation/submitted/';
